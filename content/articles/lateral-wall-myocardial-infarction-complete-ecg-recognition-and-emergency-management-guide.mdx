---
title: "Lateral Wall Myocardial Infarction: Complete ECG Recognition and Emergency Management Guide"
slug: "lateral-wall-myocardial-infarction-complete-ecg-recognition-and-emergency-management-guide"
excerpt: "Expert guide to recognizing Lateral Wall MI on ECG - clinical pearls, diagnostic criteria, and modern management approaches. Learn diagnostic ECG criteria, emergency protocols, complications to watch for, and evidence-based treatment strategies from Dr. Raj K, Emergency Medicine Physician."
author: "Dr. Raj K"
authorId: "raj-k-reddy"
publishedAt: "2025-12-13"
updatedAt: "2025-12-13"
featured: true
imageUrl: "/MI_ecg_database/Lateral_wall_MI/Lateral_wall_MI/example.png"
tags:
  - Lateral MI
  - STEMI
...
![Image](/MI_ecg_database/Lateral_wall_MI/Lateral_wall_MI/example.png)
*Lateral MI ECG Example*

    
        Figure 1: Lateral MI - Characteristic ECG Pattern
...
### 🚨 Critical Key Points
        ...
        - **Affected Territory:** Lateral MI

        - **ECG Leads Involved:** I, aVL, V5, V6

        - **Culprit Artery:** Left Circumflex artery (LCx)

        - **Primary Emergency Management:** Immediate reperfusion therapy within 90-120 minutes

        - **Mortality Risk:** Generally lower mortality (5-10%) when isolated, higher if extensive or combined with other territories

    

## Overview and Clinical Significance

**Lateral MI** is a life-threatening emergency requiring immediate recognition and treatment. Lateral MI indicates LCx occlusion, often missed or underdiagnosed due to subtle ECG changes, may occur in isolation or with other infarcts
...
### 📊 Diagnostic ECG Criteria for Lateral MI

    

        - **ST elevation in I, aVL, V5, V6**
- **Reciprocal ST depression in inferior leads**
- **High lateral (I, aVL) vs low lateral (V5, V6) patterns**
- **Tall R waves and upright T waves initially, followed by Q waves and T inversion**
...
Lateral MI occurs when there is complete occlusion of the Left Circumflex artery (LCx), leading to transmural myocardial ischemia and necrosis. The ischemic cascade progresses rapidly:
...
**Primary Strategy:** Standard STEMI protocol with reperfusion therapy, careful evaluation for extent of infarction, assessment for concomitant posterior or inferior involvement
...
**Common Complications of Lateral MI:**

Often smaller infarcts but can cause significant arrhythmias, may be part of larger inferolateral or anterolateral MI
...
**Lateral MI** is a life-threatening emergency characterized by ST elevation in I, aVL, V5, V6 indicating acute occlusion of the Left Circumflex artery (LCx).
...
**Key Complication:** Often smaller infarcts but can cause significant arrhythmias, may be part of larger inferolateral or anterolateral MI
