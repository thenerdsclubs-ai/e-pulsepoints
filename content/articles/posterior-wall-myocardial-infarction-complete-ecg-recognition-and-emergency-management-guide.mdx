---
title: "Posterior Wall Myocardial Infarction: Complete ECG Recognition and Emergency Management Guide"
slug: "posterior-wall-myocardial-infarction-complete-ecg-recognition-and-emergency-management-guide"
excerpt: "Master the diagnosis of Posterior MI - the most commonly missed STEMI. Learn mirror image ECG patterns and critical management strategies. Learn diagnostic ECG criteria, emergency protocols, complications to watch for, and evidence-based treatment strategies from Dr. Raj K, Emergency Medicine Physician."
author: "Dr. Raj K"
authorId: "raj-k-reddy"
publishedAt: "2025-12-13"
updatedAt: "2025-12-13"
featured: true
imageUrl: "/MI_ecg_database/Posterior_wall_MI/Posterior_wall_MI/example.png"
tags:
  - Posterior MI
  - STEMI
...
![Image](/MI_ecg_database/Posterior_wall_MI/Posterior_wall_MI/example.png)
*Posterior MI ECG Example*

    
        Figure 1: Posterior MI - Characteristic ECG Pattern
...
### 🚨 Critical Key Points
        ...
        - **Affected Territory:** Posterior MI

        - **ECG Leads Involved:** V1-V3 (reciprocal changes), posterior leads V7-V9 (direct changes)

        - **Culprit Artery:** Posterior descending artery (PDA) from RCA or LCx

        - **Primary Emergency Management:** Immediate reperfusion therapy within 90-120 minutes

        - **Mortality Risk:** Similar to inferior MI (5-15%), higher if extensive or combined territories

    

## Overview and Clinical Significance

**Posterior MI** is a life-threatening emergency requiring immediate recognition and treatment. Posterior MI often goes unrecognized because standard 12-lead shows reciprocal changes rather than direct ST elevation - must recognize mirror image
...
### 📊 Diagnostic ECG Criteria for Posterior MI

    

        - **Tall R waves in V1-V3 (mirror image of Q waves)**
- **ST depression in V1-V3 (reciprocal to posterior ST elevation)**
- **Upright tall T waves in V1-V3**
...
Posterior MI occurs when there is complete occlusion of the Posterior descending artery (PDA) from RCA or LCx, leading to transmural myocardial ischemia and necrosis. The ischemic cascade progresses rapidly:
...
**Primary Strategy:** HIGH INDEX OF SUSPICION required, obtain posterior leads V7-V9, immediate reperfusion therapy, often requires coronary angiography for diagnosis
...
**Common Complications of Posterior MI:**

Frequently combined with inferior MI, risk of complete heart block, papillary muscle dysfunction
...
**Posterior MI** is a life-threatening emergency characterized by ST elevation in V1-V3 (reciprocal changes), posterior leads V7-V9 (direct changes) indicating acute occlusion of the Posterior descending artery (PDA) from RCA or LCx.
...
**Key Complication:** Frequently combined with inferior MI, risk of complete heart block, papillary muscle dysfunction
