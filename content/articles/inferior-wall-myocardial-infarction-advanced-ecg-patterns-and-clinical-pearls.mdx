...
excerpt: "Essential guide to Inferior Wall MI recognition and management - understand ECG patterns, associated complications, and evidence-based treatment. Learn diagnostic ECG criteria, emergency protocols, complications to watch for, and evidence-based treatment strategies from Dr. Raj K, Emergency Medicine Physician."
author: "Dr. Raj K"
authorId: "raj-k-reddy"
publishedAt: "2025-12-13"
updatedAt: "2025-12-13"
featured: true
imageUrl: "/MI_ecg_database/Inferior_wall_MI/IWMI1.png"
tags:
  - Inferior MI
  - STEMI
...
![Image](/MI_ecg_database/Inferior_wall_MI/IWMI1.png)
*Inferior MI ECG Example*

    
        Figure 1: Inferior MI - Characteristic ECG Pattern
...
### 🚨 Critical Key Points
        ...
        - **Affected Territory:** Inferior MI

        - **ECG Leads Involved:** II, III, aVF

        - **Culprit Artery:** Right Coronary Artery (RCA) 80% or Left Circumflex (LCx) 20%

        - **Primary Emergency Management:** Immediate reperfusion therapy within 90-120 minutes

        - **Mortality Risk:** Lower than anterior MI (5-10%) but increases significantly with RV involvement or cardiogenic shock

    

## Overview and Clinical Significance

**Inferior MI** is a life-threatening emergency requiring immediate recognition and treatment. Inferior MI results from RCA or LCx occlusion, often associated with bradyarrhythmias and right ventricular involvement
...
### 📊 Diagnostic ECG Criteria for Inferior MI
...
- **Right-sided leads (V4R) positive if RV involvement**
...
The following images demonstrate different presentations and evolutionary stages of Inferior MI:

    

        
![Image](/MI_ecg_database/Inferior_wall_MI/IWMI2.png)
*Inferior MI Variation 2*
...
![Image](/MI_ecg_database/Inferior_wall_MI/IWMI3.png)
*Inferior MI Variation 3*
...
Inferior MI occurs when there is complete occlusion of the Right Coronary Artery (RCA) 80% or Left Circumflex (LCx) 20%, leading to transmural myocardial ischemia and necrosis. The ischemic cascade progresses rapidly:
...
**Primary Strategy:** Reperfusion therapy, AVOID beta-blockers and nitrates if RV involvement suspected, adequate fluid resuscitation for hypotension, temporary pacing if high-degree AV block
...
**Common Complications of Inferior MI:**

AV blocks (especially high-degree), bradycardia, RV infarction (30-50% of cases), hypotension
...
**Inferior MI** is a life-threatening emergency characterized by ST elevation in II, III, aVF indicating acute occlusion of the Right Coronary Artery (RCA) 80% or Left Circumflex (LCx) 20%.
...
**Key Complication:** AV blocks (especially high-degree), bradycardia, RV infarction (30-50% of cases), hypotension
